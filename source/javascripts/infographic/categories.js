...
.range(["rgba(43, 84, 126,1.0)", "rgba(43, 84, 126,0.9)", "rgba(43, 84, 126,0.8)", "rgba(43, 84, 126,0.7)", "rgba(43, 84, 126,0.6)", "rgba(43, 84, 126,0.5)", "rgba(43, 84, 126,0.4)", "rgba(43, 84, 126,0.3)", "rgba(43, 84, 126,0.2)", "rgba(43, 84, 126,0.1)", "rgba(43, 84, 126,0.1)", "rgba(43, 84, 126,0.1)", "rgba(43, 84, 126,0.1)"]);
...
var categories = function(data) {
  ...
  // category_counts.forEach(function(d) {
  //   d.days = +d.days;
  // });
